...
export const HomePage = () => {
  ...
  const [yrSliderValue, setyrsSliderValue] = useState(5);
    ...
    <div className=" w-full h-full ">
      <div className=" px-20 bg-gradient-to-b from-blue-500 to-[#3777FA] text-white">
        <div className=" flex justify-between items-center pt-8">
          ...
          <div className=" flex justify-center items-center space-x-5">
            ...
            >
              <h1><IoMdLock className=" text-[14px]"/></h1>Login
            </button>
          </div>
        </div>
        ...
        <div className=" w-full h-full flex justify-center items-center px-8 py-10  space-x-10">
          <div className=" w-1/2">
            <h1 
            className="text-[52px] font-bold mb-4"
            >
            ...
            <button
              ...
              onClick={() => navigate("/login")}
            >
              Register Now<h1><FaArrowRightLong /></h1>
            </button>
          </div>
      ...
      <div className=" px-28 py-16 flex flex-col justify-start items-start space-y-5">
        <h1 className="text-[36px]  font-semibold mb-4 ">
          Benefits of investing in gold with<span className=" text-[#3777FA]"> TKMV traders </span> 
        </h1>
        <ul className=" space-y-5">
          ...
          <li>
            4.our advanced gi tools to calculate you can make investment decision
            we believe in complete transparency and safety
          </li>
        </ul>
        <div className=" flex space-x-10 pt-5">
          ...
          <div className=" border-2 shadow-sm rounded-lg p-3 px-4">
            ...
            <h1 className=" py-3 text-[20px] font-semibold ">Trust</h1>
              <p className=" font-light tracking-wide pb-3 text-gray-500">
              We have guided the faith of thousand plus happy customers over the last two years
            </p>
          </div>
          <div className=" border-2 shadow-sm rounded-lg p-3 px-4">
      ...
      <div className=" px-28 py-16">
        ...
        <div className=" w-full flex  border-2 rounded-lg shadow-lg ">
      ...
      <div className="  bg-[#3f5bd9] flex justify-between items-center px-20 py-20 shadow-lg ">
        <div className=" flex flex-col justify-start items-start w-1/2 space-y-3">
          <h1 className=" text-white font-semibold text-[48px]">We Are Here To Help You!</h1>
          <h1 className=" text-gray-200 text-[18px] tracking-wider"> If you have a specific question or topic you'd like help with, please let me know, and I'll do my best to provide the information or assistance you're looking for your queries resolve faster</h1>
        </div>
      ...
      <div className=" w-full px-28 pt-20 flex flex-col justify-center items-center space-y-5 mt-8">
        ...
        <h1 className=" text-gray-500 text-[18px]">Our support team will be happy to assist you</h1>
      </div>
      <div className=" w-full px-28 flex justify-between items-center ">
        ...
        <div className=" w-1/2 flex flex-col space-y-5 justify-start items-start">
         ...
         <h1 className=" font- text-[18px]">Contact with our support team to get your queries resolved.</h1> 
         <div className=" flex space-x-5">
          <a href="tel:+918148867881" className="flex justify-center items-center gap-3 bg-[#3f5bd9] p-4 rounded-lg text-white"><IoLogoWhatsapp  className=" text-[24px]"/> +91 8148867881</a>
          <a href="mailto:atksmvtraders@gmail.com" className="flex justify-center items-center gap-3 border-2 p-4 rounded-lg text-black"><IoIosMail className=" text-[24px]"/> atksmvtraders@gmail.com</a>
         </div>
        </div>
      </div>
      <div className=" w-full bg-[#1b3a7f] pl-28 pr-3 pt-8 pb-4 ">
        ...
        <div className=" flex justify-between items-center">
          <h1 className="text-white text-[14px] mt-3">&copy;2024 TKMV TRADERS. All rights reserved </h1>
          <h1 className=" text-end text-[13px] text-gray-400">Developed by by Salman,Siraj,Basith</h1>
        </div>
