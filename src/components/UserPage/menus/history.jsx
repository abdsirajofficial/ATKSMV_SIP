...
export const History = () => {
  ...
  useEffect(() => {
    gettransactionApi(`user/transaction?userId=${localStorage.getItem("userid")}`, settransaction)
  },[])
  ...
  return (
    <div className=" px-8 py-5">
      ...
      <div className="w-full h-auto shadow-sm grid grid-cols-5 grid-rows-1 text-center rounded py-3  text-[14px] bg-white border-b-2">
